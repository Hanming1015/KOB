...
export class Snake extends AcGameObject {
    ...
    check_tail_increasing() { // 检测蛇尾是否会增加
    ...
    update_move() {
        ...
        if (distance < this.eps) { // 到达目标位置
            ...
            this.next_cell = null;
            this.status = "idle"; // 进入静止状态

            if (!this.check_tail_increasing()) { // 蛇尾不增加，删除蛇尾
                this.cells.pop();
            }
        } else {
            const move_distance = this.speed * this.timedelta / 1000; // 每帧移动的距离
